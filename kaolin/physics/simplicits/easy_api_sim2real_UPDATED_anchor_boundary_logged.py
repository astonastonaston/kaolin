...
try:
    from kaolin.physics.simplicits.losses_sim2real_UPDATED_anchor_boundary_logged import compute_losses  # local patched losses
except Exception:
...
class SimplicitsObject:
    ...
    def create_trained(pts, yms, prs, rhos, appx_vol,
        ...
        pbar = tqdm(range(training_num_steps), disable=not bool(training_progress))
        for i in pbar:
