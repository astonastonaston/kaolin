...
try:
    from losses_sim2real import compute_losses  # local patched losses
except Exception:
    ...
    def create_trained(pts, yms, prs, rhos, appx_vol,
        ...
        for i in range(training_num_steps):
            ...
            le, lo, ls = compute_losses(model, 
                                    ...
                                    sim2real_inner_steps=sim2real_inner_steps,
                                    sim2real_inner_lr=sim2real_inner_lr,
                                    sim2real_reg=sim2real_reg)
            loss = le + lo + ls
